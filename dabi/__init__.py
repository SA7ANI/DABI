...
if ENV:
    ...
    from dabi.config import Development as Config
...
client = TelegramClient("dabi", api_id, api_hash)
...
from dabi.modules.helper_funcs.handlers import CustomCommandHandler
