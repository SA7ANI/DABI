...
import dabi.modules.sql.notes_sql as sql
from dabi import dispatcher, LOGGER, OWNER_ID, MESSAGE_DUMP
from dabi.__main__ import DATA_IMPORT
...
# from dabi.modules.rules import get_rules
import dabi.modules.sql.rules_sql as rulessql

# from dabi.modules.sql import warns_sql as warnssql
import dabi.modules.sql.blacklist_sql as blacklistsql
from dabi.modules.sql import disable_sql as disabledsql

# from dabi.modules.sql import cust_filters_sql as filtersql
# import dabi.modules.sql.welcome_sql as welcsql
import dabi.modules.sql.locks_sql as locksql
from dabi.modules.connection import connected
...
def import_data(update, context):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        ...
        try:
            ...
            msg.reply_text(
                "An error occurred while recovering your data. The process failed. If you experience a problem with this, please ask @SA7ANI"
            )
...
def export_data(update, context):
    ...
    f = open("Dabi{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Dabi{}.backup".format(chat_id), "rb"),
        caption="*Successfully imported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `dabi-Backup` is specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Dabi{}.backup".format(chat_id))  # Cleaning file
