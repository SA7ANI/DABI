...
def gdpr(update, context):
    ...
    update.effective_message.reply_text(
        ...
        "you from any chats, as that is telegram data, not Dabi data. "
...
def src(update, context):
    update.effective_message.reply_text(
        "Hey there! You can find what makes me click [here](https://github.com/SA7ANI/DABI).",
        parse_mode=ParseMode.MARKDOWN,
