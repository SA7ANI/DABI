...
import dabi.modules.sql.global_bans_sql as sql
from dabi.modules.sql.users_sql import get_user_com_chats
from dabi import (
    EVENT_LOGS,
    OWNER_ID,
    STRICT_GBAN,
...
def __user_info__(user_id):
    ...
    if user_id == dispatcher.bot.id:
        return ""
    if int(user_id) in SUDO_USERS + SUPPORT_USERS + WHITELIST_USERS:
        return ""
    if is_gbanned:
