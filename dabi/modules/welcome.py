...
import dabi.modules.sql.welcome_sql as sql
from dabi.modules.sql.global_bans_sql import is_user_gbanned
from dabi import dispatcher, OWNER_ID, LOGGER, MESSAGE_DUMP, spamwtc
from dabi.modules.helper_funcs.chat_status import user_admin, is_user_ban_protected
from dabi.modules.helper_funcs.misc import build_keyboard, revert_buttons
from dabi.modules.helper_funcs.msg_types import get_welcome_type
from dabi.modules.helper_funcs.alternate import typing_action
from dabi.modules.helper_funcs.string_handling import (
    markdown_parser,
        ...
        for new_mem in new_members:
            ...
            # Make bot greet admins
                ...
                update.effective_message.reply_text(
                    ...
                    " and be sure to join our group: @TheKonoha11 to know more about updates and tricks!".format(
                ...
                context.bot.send_message(
                    MESSAGE_DUMP,
                    "Dabi have been added to <pre>{}</pre> with ID: \n<pre>{}</pre>".format(
                        chat.title, chat.id
                    ),
                    parse_mode=ParseMode.HTML,
                )
