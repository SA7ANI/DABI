...
from hinata import dispatcher, OWNER_ID, LOGGER, MESSAGE_DUMP, spamwtc
from hinata.modules.helper_funcs.chat_status import user_admin, is_user_ban_protected
