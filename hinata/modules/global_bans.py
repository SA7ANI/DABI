...
from hinata.modules.helper_funcs.chat_status import user_admin, is_user_admin
...
def __user_info__(user_id):
    ...
    if is_gbanned:
        ...
        if user.reason:
            ...
            text += "\n\nAppeal at @HyugaHinataBot if you think it's invalid."
    else:
        text = text.format("No")
    return text
