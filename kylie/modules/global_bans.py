...
import kylie.modules.sql.global_bans_sql as sql
from kylie import (
    dispatcher,
    OWNER_ID,
    SUDO_USERS,
...
from kylie.modules.helper_funcs.chat_status import user_admin, is_user_admin
from kylie.modules.helper_funcs.extraction import extract_user, extract_user_and_text
from kylie.modules.helper_funcs.filters import CustomFilters
from kylie.modules.helper_funcs.alternate import typing_action, send_action
from kylie.modules.sql.users_sql import get_all_chats
...
def __user_info__(user_id):
    ...
    if is_gbanned:
        ...
        if user.reason:
            ...
            text += "\n\nAppeal at @MissKylieBot if you think it's invalid."
    else:
        text = text.format("No")
    return text
