...
import kylie.modules.sql.notes_sql as sql
from kylie import dispatcher, LOGGER, OWNER_ID, MESSAGE_DUMP
from kylie.__main__ import DATA_IMPORT
from kylie.modules.helper_funcs.chat_status import user_admin
from kylie.modules.helper_funcs.alternate import typing_action

# from kylie.modules.rules import get_rules
import kyliekylie.modules.sql.rules_sql as rulessql

# from kylie.modules.sql import warns_sql as warnssql
import kylie.modules.sql.blacklist_sql as blacklistsql
from kylie.modules.sql import disable_sql as disabledsql

# from kylie.modules.sql import cust_filters_sql as filtersql
# import kylie.modules.sql.welcome_sql as welcsql
import kylie.modules.sql.locks_sql as locksql
from kylie.modules.connection import connected
...
def import_data(update, context):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        ...
        try:
            ...
            msg.reply_text(
                "An error occurred while recovering your data. The process failed. If you experience a problem with this, please ask @PatrickDeadStar"
            )
...
def export_data(update, context):
    ...
    f = open("KYLIE{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("KYLIE{}.backup".format(chat_id), "rb"),
        caption="*Successfully imported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `KYLIE-Backup` is specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("KYLIE{}.backup".format(chat_id))  # Cleaning file
