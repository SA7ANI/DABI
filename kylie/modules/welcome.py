...
import kylie.modules.sql.welcome_sql as sql
from kylie.modules.sql.global_bans_sql import is_user_gbanned
from kylie import dispatcher, OWNER_ID, LOGGER, MESSAGE_DUMP, spamwtc
from kylie.modules.helper_funcs.chat_status import user_admin, is_user_ban_protected
from kylie.modules.helper_funcs.misc import build_keyboard, revert_buttons
from kylie.modules.helper_funcs.msg_types import get_welcome_type
...
from kylie.modules.log_channel import loggable
        ...
        for new_mem in new_members:
            ...
            # Make bot greet admins
                ...
                update.effective_message.reply_text(
                    ...
                    " and be sure to join our group: @BikiniBottomStaff to know more about updates and tricks!".format(
