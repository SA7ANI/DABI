...
from kylie.modules.helper_funcs.string_handling import markdown_parser
from kylie.modules.disable import DisableAbleCommandHandler

import kylie.modules.sql.feds_sql as sql

from kylie.modules.helper_funcs.alternate import (
    send_message,
    typing_action,
    send_action,
)
    ...
    if args:
        if args[0] == "json":
            ...
            with BytesIO(str.encode(backups)) as output:
                output.name = "kylie_fbanned_users.json"
                update.effective_message.reply_document(
                    document=output,
                    filename="kylie_fbanned_users.json",
            ...
            with BytesIO(str.encode(backups)) as output:
                ...
                update.effective_message.reply_document(
                    document=output,
                    filename="kylie_fbanned_users.csv",
