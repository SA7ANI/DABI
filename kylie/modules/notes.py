...
from kylie import dispatcher, MESSAGE_DUMP, LOGGER
from kylie.modules.disable import DisableAbleCommandHandler
from kylie.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from kylie.modules.helper_funcs.misc import build_keyboard, revert_buttons
from kylie.modules.helper_funcs.msg_types import get_note_type
from kylie.modules.helper_funcs.string_handling import (
...
def list_notes(update, context):
    ...
    if not note_list:
        ...
        try:
            ...
            update.effective_message.reply_text(
                "There was a problem in showing notes list, maybe due to some invalid character in note names. Ask in @MissKylieBot if you're unable to figure it out!"
            )
