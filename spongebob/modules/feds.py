...
from spongebob.modules.helper_funcs.alternate import (
    send_message,
    typing_action,
    send_action,
)
    ...
    if args:
        if args[0] == "json":
            ...
            with BytesIO(str.encode(backups)) as output:
                output.name = "spongebob_fbanned_users.json"
                update.effective_message.reply_document(
                    document=output,
                    filename="spongebob_fbanned_users.json",
            ...
            with BytesIO(str.encode(backups)) as output:
                ...
                update.effective_message.reply_document(
                    document=output,
                    filename="spongebob_fbanned_users.csv",
