...
from spongebob.modules.helper_funcs.alternate import typing_action, send_action
...
def gdpr(update, context):
    ...
    update.effective_message.reply_text(
        ...
        "you from any chats, as that is telegram data, not SpongeBob data. "
...
def src(update, context):
    update.effective_message.reply_text(
        "Hey there! You can find what makes me click [here](https://github.com/PatrickDeadStar/SpongeBob).",
        parse_mode=ParseMode.MARKDOWN,
        disable_web_page_preview=True,
    )
