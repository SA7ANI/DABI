...
from spongebob import dispatcher, MESSAGE_DUMP, LOGGER
from spongebob.modules.disable import DisableAbleCommandHandler
from spongebob.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
...
def list_notes(update, context):
    ...
    if not note_list:
        ...
        try:
            ...
            update.effective_message.reply_text(
                "There was a problem in showing notes list, maybe due to some invalid character in note names. Ask in @SpongeBobNobot if you're unable to figure it out!"
            )
