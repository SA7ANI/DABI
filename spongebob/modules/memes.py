...
`/decide` can be also used with regex like: `spongebob? <question>: randomly answer "Yes, No" etc.`

Some other regex filters are:
`me too` | `goodmorning` | `goodnight`.

SpongeBob will reply random strings accordingly when these words are used!
