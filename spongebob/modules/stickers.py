    ...
    try:
        ...
        if png_sticker:
            success = context.bot.create_new_sticker_set(
                user.id,
                packname,
                f"{name}s spongebob pack" + extra_version,
        ...
        if tgs_sticker:
            success = context.bot.create_new_sticker_set(
                user.id,
                packname,
                f"{name}s animated spongebob pack" + extra_version,
...
Kanging Stickers made easy with stickers module!
 ...
 • /bang <text>: Turn a text into sticker.
 You'll get a random colour from rainbow
"""
