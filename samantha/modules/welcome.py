...
from samantha import dispatcher, OWNER_ID, LOGGER, MESSAGE_DUMP, spamwtc
from samantha.modules.helper_funcs.chat_status import user_admin, is_user_ban_protected
        ...
        for new_mem in new_members:
            ...
            # Make bot greet admins
                ...
                context.bot.send_message(
                    MESSAGE_DUMP,
                    "Samantha have been added to <pre>{}</pre> with ID: \n<pre>{}</pre>".format(
                        chat.title, chat.id
                    ),
                    parse_mode=ParseMode.HTML,
                )
