...
from samantha import dispatcher, LOGGER, OWNER_ID, MESSAGE_DUMP
...
def export_data(update, context):
    ...
    f = open("Samantha{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        ...
        caption="*Successfully imported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `samantha-Backup` is specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
