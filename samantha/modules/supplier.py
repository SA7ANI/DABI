...
import nekos
import samantha.modules.sql.supplier_sql as sql
...
from samantha import dispatcher, MESSAGE_DUMP
    ...
    def allowed_chat(update, context, *args, **kwargs):
        ...
        if isAllowed or chat.type == "private":
            ...
            update.effective_message.reply_text(
                "It's Private Group only stuffs, if you want ask for approval [Here](httpd://t.me/TheKonoha11)"
            )
    return allowed_chat


@run_async
def hsadd(update, context):
    args = context.args
...
__help__ = """
🔞
*Hentai Supplier* for your Private Groups, powerd by [ɴᴇᴋᴏs ᴀᴘɪ](https://nekos.life/) I can supply you loads of anime wallpapers and hentai images for free!
If you want Hentai Supplier in your Private Group, ask [Here](https://t.me/TheKonoha11) for approval of your group.
...
HSREMOVE_HANDLER = CommandHandler("hsremove", hsremove, pass_args=True, filters=CustomFilters.sudo_filter)
...
dispatcher.add_handler(HSADD_HANDLER)
dispatcher.add_handler(HSREMOVE_HANDLER)
