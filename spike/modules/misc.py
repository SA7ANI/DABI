...
from spike.__main__ import STATS, USER_INFO, GDPR
...
def gdpr(update, context):
    ...
    update.effective_message.reply_text(
        ...
        "you from any chats, as that is telegram data, not Spike data. "
...
def src(update, context):
    update.effective_message.reply_text(
        "Hey there! You can find what makes me click [here](https://github.com/PatrickDeadStar/Spike).",
        parse_mode=ParseMode.MARKDOWN,
        disable_web_page_preview=True,
    )
