...
if ENV:
    ...
    from spike.config import Development as Config
...
client = TelegramClient("spike", api_id, api_hash)

#Pyrogram
pbot = Client("SpikePyro", api_id=TELETHON_ID, api_hash=TELETHON_HASH, bot_token=TOKEN)
...
from spike.modules.helper_funcs.handlers import CustomCommandHandler
